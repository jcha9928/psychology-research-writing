...
Week 2부터는 AI를 활용한 Nature/Science급 초록 작성을 배웁니다.
수업 전 사전학습이 필수이며, 다음 준비물이 반드시 필요합니다:

### 필수 준비물

**1. 자신의 연구 초록 Baseline Draft**
- 분량: 150-200 words
- 형식: 자유 (완벽하지 않아도 됨)
- 대안: 초록이 없으면 서론 첫 문단도 가능
- 용도: Week 2 수업에서 AI로 Nature/Science급으로 개선

**왜 필요한가?**
- Week 2는 AI를 사용한 초록 개선 실습입니다
- 여러분의 실제 연구로 작업해야 배운 내용을 바로 적용 가능
- 사전학습에서 4가지 Opening 패턴을 여러분 초록에 적용해볼 예정

**2. 사전학습 완료 (수업 3일 전 공지 예정)**
- 영상 시청: 약 20분
- 읽기 자료: Nature/Science vs 일반 저널 초록 비교
- Google Form 제출: 4문항
- 예상 시간: 60-90분
